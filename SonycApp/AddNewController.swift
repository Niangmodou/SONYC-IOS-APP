...
var timer: Timer!
var slidingUp = FloatingPanelController()
...
//        let newTask = NSManagedObject(entity: entity!, insertInto: context)
        ...
        slidingUp.willMove(toParent: nil)
        slidingUp.view.removeFromSuperview()
        slidingUp.removeFromParent()
...
//           }
        ...
        currentSoundTitle.frame = CGRect(x: screenWidth/7, y: screenHeight/14, width: screenWidth - 30, height: screenHeight/35)
        ...
        avgDecibels.textColor = UIColor.black
        minDecibels.textColor = UIColor.black
        maxDecibels.textColor = UIColor.black
        avg.textColor = UIColor.black
        min.textColor = UIColor.black
        max.textColor = UIColor.black
        counterLabel.textColor = UIColor.black
        currentSoundTitle.textColor = UIColor.black
...
//        print("Before the if statmement if micTapped");
//        if micTapped {
//            mic.removeTap(onBus: 0)
//            micTapped = false
//            print("inside the if statmement if micTapped");
//            return
//        }
//
//        print("after the if statmement if micTapped");
...
//            let _ = navigationController?.popViewController(animated: true)
    ...
    @objc func createReport(_ sender: Any) {
        stopAndResetAudio()
