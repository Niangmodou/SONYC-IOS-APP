...
//let menu = SideMenuNavigationController.init(rootViewController: MenuListController())
...
class ViewController: UIViewController, AVAudioRecorderDelegate{
    ...
    override func viewDidLoad() {
        ...
        leftBarButton = UIBarButtonItem(image: UIImage(named: "Hamburger.png"), style: .plain, target: self, action: #selector(didTapHamburger(_:)))
//        self.navigationItem.leftBarButtonItem = menu
        leftBarButton.image = UIImage(named: "Hamburger.png");
        ...
        tapToLogin.textColor = UIColor.black
    ...
    @objc func didTapHamburger(_ sender: Any){
