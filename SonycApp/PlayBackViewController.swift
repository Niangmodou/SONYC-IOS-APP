...
//        location = (newTask.value(forKey: "reportAddress") as? String)
        ...
        locationTypeLabel.textColor = UIColor.black
        ...
        youAreWordsLabel.textColor = UIColor.black
        ...
        youFeelWordsLabel.textColor = UIColor.black
        ...
        youAreLabel.textColor = UIColor.black
...
func prepareToPlayFile(){
    do{
//        print(newTask.value(forKey: "path"))
